...
const checkEmpty = data => Object.entries(data).filter(entry => entry[0] !== 'password_confirm')
...
const checkLength = data => Object.keys(data).filter(e => e !== 'password_confirm' && e !== 'password' && e !== 'email')
